...
test("@Web More validations check", { tag: '@web' }, async ({ page }) => {
...
test("Screenshot and visual validations", { tag: '@web' },async ({ page }) => {
    await page.goto("https://rahulshettyacademy.com/AutomationPractice/");
    await expect(page.locator('#displayed-text')).toBeVisible();
...
test("Visual comparison test", { tag: '@web' },async ({ page }) => {
